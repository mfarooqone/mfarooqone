...
- **Frameworks**: Flutter, Firebase, Node.js, Express
- **Tools**: Git, GitHub, Bitbucket, Docker, CI/CD, Jira
- **Databases**: Firestore, MySQL, SQLite
- **Mobile Platforms**: iOS, Android

## 🔭 Currently Working On

- Improving the **`liquid_loader`** Flutter package with more animations and customization.
